...
public class TwitchChannelSubscribeEvent extends TwitchEvent {
    ...
    public TwitchChannelSubscribeEvent(String eventId, String apiName, JsonObject rawData) {
        ...
        this.isGift = rawData.get("is_gift").getAsBoolean();
    }
