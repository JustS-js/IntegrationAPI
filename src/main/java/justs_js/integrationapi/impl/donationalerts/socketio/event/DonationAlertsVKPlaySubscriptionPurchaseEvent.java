...
public class DonationAlertsVKPlaySubscriptionPurchaseEvent extends DonationAlertsEvent{
    ...
    public DonationAlertsVKPlaySubscriptionPurchaseEvent(String eventId, String apiName, JsonObject rawData) {
