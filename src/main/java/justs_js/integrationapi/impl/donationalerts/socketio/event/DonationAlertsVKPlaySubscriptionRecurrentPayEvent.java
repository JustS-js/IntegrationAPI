...
public class DonationAlertsVKPlaySubscriptionRecurrentPayEvent extends DonationAlertsEvent{
    ...
    public DonationAlertsVKPlaySubscriptionRecurrentPayEvent(String eventId, String apiName, JsonObject rawData) {
